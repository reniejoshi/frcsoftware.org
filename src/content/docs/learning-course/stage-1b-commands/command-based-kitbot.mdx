...
```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbot.java#robotDef
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbot.java#feederDef
...
```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbot.java#feederSim
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbot.java#triggerBindingDef
