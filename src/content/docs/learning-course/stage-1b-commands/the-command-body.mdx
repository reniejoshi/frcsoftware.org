...
```java stage1/snippets-1b/src/main/java/sources/CommandBody.java#triangleLoop
...
```java stage1/snippets-1b/src/main/java/sources/CommandBody.java#fullThrottleCmdBody

```

And this command body would rotate your robot by roughly 90 degrees, then stop:

```java stage1/snippets-1b/src/main/java/sources/CommandBody.java#rotate90CommandBody
