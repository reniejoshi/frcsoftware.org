...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#mechanismDef
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#mechanismInRobotDef
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#commandDef
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#commandWithPriorityDef
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#fullThrottleIntake
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#runAtThrottleCommand
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#commandAwait

```

That means you can run multiple commands in sequence:

```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt1.java#commandSequence
