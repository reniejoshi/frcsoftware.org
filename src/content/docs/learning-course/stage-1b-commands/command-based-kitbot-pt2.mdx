...
```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#drivetrainDef
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#arcadeDriveBody
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#driveCommand
...
```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#opModeSkeleton
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#startMethod
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#4SecDriveCommand
...
<details class="accordion">
    ...
    ```java stage1/snippets-1b/src/main/java/sources/CommandBasedKitbotPt2.java#rotateInPlaceBody
