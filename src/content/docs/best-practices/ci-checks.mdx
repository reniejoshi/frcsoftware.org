...
Using static analysis tools are considered a good practice because they offer automated ways of flagging bad programming practices such as unused code.
