...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt2.java#defaultCommand
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt2.java#delayCommand

```

You can also give an existing command a timeout with the `withTimeout()` modifier:

```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt2.java#timeoutCommand
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt2.java#noRequirementsCommand
...
```java stage1/snippets-1b/src/main/java/sources/CommandsAndMechsPt2.java#parallelCommands
